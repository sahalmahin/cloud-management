...
const Pricing = () => {
    return (
        <div name='pricing' className='w-full text-white my-24 bg-slate-900 absolute'>
                ...
                <div className='grid md:grid-cols-2'>
                    ...
                    <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                        ...
                        <div className='text-2xl'>
                            <p className='flex py-4'><FaCheckDouble className='mr-5 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><FaCheckDouble className='mr-5 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><FaCheckDouble className='mr-5 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><FaCheckDouble className='mr-5 text-green-600' />Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><FaCheckDouble className='mr-5 text-green-600' />Lorem, ipsum dolor.</p>
